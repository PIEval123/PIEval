...
from .CombineAdaptiveAttacker import CombineAdaptiveAttacker
from .NanoGCGAttacker import NanoGCGAttacker
from .NanoGCGAdaptiveAttacker import NanoGCGAdaptiveAttacker
...
def create_attacker(attack_strategy, task):
    ...
    elif attack_strategy == 'combine_adaptive':
        return CombineAdaptiveAttacker(attack_strategy, task)
    
    elif attack_strategy == 'gcg':
        return NanoGCGAttacker(attack_strategy, task)

    elif attack_strategy == 'gcg_adaptive':
        return NanoGCGAdaptiveAttacker(attack_strategy, task)
